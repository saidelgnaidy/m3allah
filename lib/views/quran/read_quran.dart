                                      ...
                                      children:
                                        ...
                                        (i) {
                                          return TextSpan(
                                            children: [
                                              TextSpan(
                                                text: readQuran.surahList[surahI].verse
                                                    .verses[readQuran.calcStartIndex(surah: readQuran.surahList[surahI], i: i).start],
                                              ...
                                              TextSpan(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  fontSize: (Theme.of(context).textTheme.caption?.fontSize ?? 10) - 4,
                                                  fontFamily: 'font7',
                                                ),
                                              ),
                                            ],
