                    ...
                    child: Column(
                      children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      BlocBuilder<Seb7aCounterBloc, Seb7aCounterState>(builder: (context, state) {
                                        return Text(
                        ...
                        Container(
                          ...
                          decoration:
                              BoxDecoration(color: Theme.of(context).iconTheme.color?.withOpacity(.2), shape: BoxShape.circle, boxShadow: kBoxShadow()),
