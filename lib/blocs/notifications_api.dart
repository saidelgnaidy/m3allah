...
class NotificationCtrl {
  ...
  static sendNotification() async {
    ...
    //final List<Seb7aZekr> azkar = await _loadSeb7aZekr();
    final int index = Random().nextInt(StaticVars.smallDo3a2.length - 1);
    //final Seb7aZekr _zekr = azkar[index];
  ...
  static initWorkMan() {
    ...
    Workmanager().registerPeriodicTask('azkar654', 'azkar work manager2', frequency: const Duration(minutes: 15));
  }
